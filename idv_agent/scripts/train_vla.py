...
def train(args: argparse.Namespace) -> dict[str, Any]:
    ...
    manifest = build_manifest(
        ...
        trainable=["condition_projection", "state_decision_expert",
        ...
        training={"method": "action_chunk_sft", "steps": args.steps, "learning_rate": args.lr,
                  ...
                  "architecture": "m28_shared_state_conditioned_joint_planner",
                  "planner_state_source": "predicted_soft_beliefs_only",
                  "desired_turn_supervises": "deployed_h0_camera_logits",
